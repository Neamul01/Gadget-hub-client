...
const Header = () => {
    ...
    return (
        <nav className="bg-gray-200 shadow-lg dark:bg-gray-800">
            <div className="container px-6 py-4 mx-auto md:flex md:justify-between md:items-center">
                <div className="flex items-center justify-between">
                    <div>
                        <Link className="text-2xl font-bold text-gray-800 transition-colors duration-200 transform dark:text-white lg:text-3xl hover:text-gray-700 dark:hover:text-gray-300" to={'/'}>Gadget Hub</Link>
                    </div>
                ...
                <div className="items-center md:flex" hidden={show}>
                    <div className="flex flex-col md:flex-row md:mx-6">
                        ...
                        <Link className="my-1 text-sm font-medium text-gray-700 transition-colors duration-200 transform dark:text-gray-200 hover:text-blue-500 dark:hover:text-blue-400 md:mx-4 md:my-0" to='/blogs'>Blogs</Link>
                        ...
                        {
                            user ?
                                <button onClick={handleSignOut} className="my-1 text-sm font-medium text-gray-700 transition-colors duration-200 transform dark:text-gray-200 hover:text-blue-500 dark:hover:text-blue-400 md:mx-4 md:my-0">Sign Out</button>
                                :
